...
var AgGridNg2 = (function () {
    function AgGridNg2(elementDef, viewContainerRef, ng2FrameworkFactory, zone) {
        var _this = this;
    ...
    AgGridNg2.prototype.escapeZone = function (timeoutOrInterval, period, action) {
        var _this = this;
        this.zone.runOutsideAngular(function () {
            timeoutOrInterval.apply(window, [function () { return _this.zone.run(action); }, period]);
        }, period);
    };
    ...
    AgGridNg2 = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof core_1.ElementRef !== 'undefined' && core_1.ElementRef) === 'function' && _a) || Object, (typeof (_b = typeof core_1.ViewContainerRef !== 'undefined' && core_1.ViewContainerRef) === 'function' && _b) || Object, ng2FrameworkFactory_1.Ng2FrameworkFactory, (typeof (_c = typeof core_1.NgZone !== 'undefined' && core_1.NgZone) === 'function' && _c) || Object])
    ], AgGridNg2);
    return AgGridNg2;
    var _a, _b, _c;
}());
